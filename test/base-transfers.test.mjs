...
test("decodeLog: rejects non-ERC-20 Transfer logs", () => {
  ...
  assert.equal(decodeLog({ ...good, topics: [...good.topics, topic("0x33")] }), null); // ERC-721 (4 topics)
  assert.equal(decodeLog({ ...good, topics: ["0xdeadbeef", good.topics[1], good.topics[2]] }), null); // wrong sig
});
