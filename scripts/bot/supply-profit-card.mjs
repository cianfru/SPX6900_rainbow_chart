...
export function supplyProfitSvg(stats, opts = {}) {
  ...
  const zones = band(66, 100, HOT, 0.22) + band(0, 34, COOL, 0.22);
...
<linearGradient id="spfill" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stop-color="${GRN}" stop-opacity="0.55"/><stop offset="55%" stop-color="${GRN}" stop-opacity="0.16"/><stop offset="100%" stop-color="${GRN}" stop-opacity="0"/></linearGradient>
...
<circle cx="${curX.toFixed(1)}" cy="${curY.toFixed(1)}" r="13" fill="#4ade80" stroke="#05050e" stroke-width="3"/>
<text x="${(curX - 22).toFixed(1)}" y="${(curY + 9).toFixed(1)}" fill="#bbf7d0" font-size="30" font-weight="800" text-anchor="end" font-family="sans-serif">${sip.toFixed(0)}%</text>
