...
export function hodlWavesSvg(stats, opts = {}) {
  ...
  const W = opts.W ?? 1200, H = opts.H ?? 630, mL = 76, mR = 132, mT = 128, mB = 92, pW = W - mL - mR, pH = H - mT - mB;
...
<text x="60" y="58" fill="#e2e8f0" font-size="36" font-weight="800" font-family="sans-serif" letter-spacing="1">SPX6900 — HODL WAVES</text>
<text x="60" y="102" fill="${BANDS[4].c}" font-size="28" font-weight="800" font-family="sans-serif">${oldPct.toFixed(0)}% of supply hasn't moved in over a year</text>
