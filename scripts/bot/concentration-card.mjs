...
export function concentrationSvg(stats, opts = {}) {
  ...
  const W = opts.W ?? 1200, H = opts.H ?? 630, mL = 92, mR = 92, mT = 122, mB = 92, pW = W - mL - mR, pH = H - mT - mB;
...
<polyline points="${line100}" fill="none" stroke="${A100}" stroke-width="6.2" stroke-linejoin="round" stroke-linecap="round"/>
