      ...
      <div style={{ position: "relative" }}>
        ...
        <ResponsiveContainer width="100%" height={isMobile ? 400 : 560}>
          <ComposedChart data={view.vis} margin={{ top: 10, right: isMobile ? 8 : 20, bottom: 24, left: isMobile ? 0 : 12 }}
            ...
            <ReferenceArea y1={1} y2={view.yDomain[1]} fill={HOT} fillOpacity={0.08} stroke="none" label={zLabel(0, "overbought vs alts", HOT)} />
            <ReferenceArea y1={view.yDomain[0]} y2={-1} fill={COOL} fillOpacity={0.08} stroke="none" label={zLabel(0, "cheap vs alts", COOL)} />
