...
export const CHART_GROUPS = [
  ...
  },
  {
    ...
    charts: [
      ...
      { id: "whalewatch", title: "Whale City (3D)", post: "whalewatch", desc: "The biggest holders as a city — find your neighbourhood, see who is adding or selling." },
...
export const AEON_GROUPS = [
  {
    ...
    charts: [
      ...
      { id: "aeonskyline", title: "Aeon City (3D)", desc: "Every holder is a building in Manhattan — find your neighbourhood, see who is buying or selling." },
