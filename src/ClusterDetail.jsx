  ...
  return (
    <PositionDetail
      ...
      head={{
        ...
        meta: <span style={{ fontFamily: "var(--mono)", fontSize: 12, padding: "3px 9px", borderRadius: 999, background: "rgba(129,140,248,0.16)", color: "#a5b4fc" }}>{(c.wallets?.length || 0)} wallets · one owner</span>,
        links: [],
      }}
      footer={
