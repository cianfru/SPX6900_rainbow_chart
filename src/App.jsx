        ...
        <div className="tchart" style={{ maxWidth: MAX_W, margin: "0 auto" }} onTouchStart={onTStart} onTouchEnd={onTEnd}>
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16, flexWrap: "wrap" }}>
            ...
            <MenuBtn onClick={() => setFsOpen(true)}
              title={isMobile ? "Rotate device for a wide, full-screen chart" : "Open a full-screen chart"}
              label={isMobile ? "Rotate" : "Fullscreen"} style={{ marginLeft: "auto" }}
              icon={isMobile
                ? <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><rect x="4" y="2.5" width="9" height="17" rx="2" /><line x1="6" y1="16.8" x2="11" y2="16.8" /><path d="M16 6.5a7 7 0 0 1 4 6.5" /><path d="M20 9.5V13h-3.4" /></svg>
                : <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round"><path d="M8 3H5a2 2 0 0 0-2 2v3M16 3h3a2 2 0 0 1 2 2v3M8 21H5a2 2 0 0 1-2-2v-3M16 21h3a2 2 0 0 0 2-2v-3" /></svg>} />
