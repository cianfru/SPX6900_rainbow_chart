...
export default function PiCycleChart({ series, isMobile, preview = false }) {
  ...
  const cur = all.cur, peak = all.peak, st = piCycleState(cur.ratio);
  ...
  return (
    <div style={{ maxWidth: MAX_W, margin: "0 auto" }}>
      ...
      <div style={{ position: "relative" }}>
        ...
        <ResponsiveContainer width="100%" height={isMobile ? 400 : 560}>
          <ComposedChart data={view.vis} margin={{ top: 10, right: isMobile ? 8 : 20, bottom: 24, left: isMobile ? 0 : 12 }}
            ...
            <ReferenceArea y1={1} y2={yTop} fill="#f87171" fillOpacity={0.10} stroke="none"
              label={preview ? undefined : { value: "top zone", position: "insideTopLeft", fill: "#f87171", fontSize: 11, fontFamily: MONO }} />
            <ReferenceArea y1={0.5} y2={1} fill="#fbbf24" fillOpacity={0.08} stroke="none" />
            <ReferenceArea y1={0.4} y2={0.5} fill="#38bdf8" fillOpacity={0.10} stroke="none" />
            <ReferenceArea y1={0} y2={0.4} fill="#4ade80" fillOpacity={0.10} stroke="none"
            ...
            <ReferenceLine y={1} stroke="#f87171" strokeWidth={1.4} strokeDasharray="6 4"
              label={preview ? undefined : { value: "top signal 1.0", position: "insideRight", fill: "#f87171", fontSize: 11, fontFamily: MONO }} />
            <ReferenceLine y={0.5} stroke="#38bdf8" strokeWidth={1.4} strokeDasharray="6 4"
      ...
      <div style={{ fontFamily: SANS, fontSize: 12.5, color: "#64748b", textAlign: "center", marginTop: 12, lineHeight: 1.65, maxWidth: 900, marginInline: "auto" }}>
        ...
        Above <strong style={{ color: "#f87171" }}>1</strong> is Bitcoin&apos;s top zone; below <strong style={{ color: "#38bdf8" }}>0.5</strong> has historically been an accumulation zone.
        It ran hot at SPX6900&apos;s 2025 top and now sits at <strong style={{ color: st.color }}>{fR(cur.ratio)}</strong> ({st.label}).
