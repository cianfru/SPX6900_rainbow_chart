    ...
    <div style={{ maxWidth: MAX_W, margin: "0 auto" }}>
      ...
      <ResponsiveContainer width="100%" height={isMobile ? 400 : 560}>
        <ComposedChart data={rows} margin={{ top: 10, right: isMobile ? 14 : 32, bottom: 24, left: isMobile ? 0 : 12 }}>
          ...
          <Line dataKey="upper" stroke="#dc2626" strokeWidth={2} dot={false} isAnimationActive={false} name="upper limit" />
          <Line dataKey="fair" stroke="#84cc16" strokeWidth={2.6} dot={false} isAnimationActive={false} name="fair value" />
          <Line dataKey="lower" stroke="#3b82f6" strokeWidth={2} dot={false} isAnimationActive={false} name="lower limit" />
          <Line dataKey="price" stroke="#ffffff" strokeWidth={2} dot={false} connectNulls={false} isAnimationActive={false} name="price" />
        </ComposedChart>
      </ResponsiveContainer>
