      ...
      {view === "who" ? (
        ...
        <ResponsiveContainer width="100%" height={isMobile ? 400 : 560}>
          <ComposedChart margin={{ top: 12, right: 72, left: 6, bottom: 6 }}>
            ...
            <ReferenceArea y1={now} y2={pMax} fill="#fb7185" fillOpacity={0.223} ifOverflow="hidden" />
            <ReferenceArea y1={pMin} y2={now} fill="#4ade80" fillOpacity={0.285} ifOverflow="hidden" />
