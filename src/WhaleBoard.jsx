    ...
    <div style={{ maxWidth: 1180, margin: "0 auto", padding: "0 14px", fontFamily: SANS }}>
      ...
      <p style={{ fontSize: 12.5, color: "#7c8a9e", lineHeight: 1.6, margin: "14px 2px 0" }}>
        {source === "static"
          ...
          : <>Whales that moved, biggest <b style={{ color: "#fb7185" }}>net offloaders</b> first, across chains. <b style={{ color: CHAIN_TAG.eth.c }}>Ethereum</b> and <b style={{ color: CHAIN_TAG.base.c }}>Base</b> are <b>live</b> — 7-day net with a <b style={{ color: "#fb7185" }}>pulse</b> when a wallet also moved in the last few hours (ETH earmarks from its first sale, its idle clock resetting on every move; <b style={{ color: "#fbbf24" }}>◱ REDUCING</b> = sold across several days). <b style={{ color: CHAIN_TAG.sol.c }}>Solana</b> {solIsLive ? <>is <b>live</b> too — its balance now vs a past slot (an archival node)</> : <>is the 30-day net from the daily reconstruction (its live feed needs an archival node)</>}. The coloured cap is holder age; tap any wallet for its Zerion card (Zerion covers all three chains). Cost basis isn&rsquo;t shown on the bridged chains — only balance + flow are honest there. Not a signal.</>}
      </p>
    </div>
  );
}
