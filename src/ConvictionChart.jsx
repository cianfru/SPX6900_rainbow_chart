      ...
      <div style={{ position: "relative" }}>
        ...
        <ResponsiveContainer width="100%" height={isMobile ? 400 : 560}>
          <ComposedChart data={view.vis} margin={{ top: 10, right: isMobile ? 8 : 20, bottom: 24, left: isMobile ? 0 : 12 }}
            ...
            <ReferenceArea y1={80} y2={100} fill="#22d3ee" fillOpacity={0.07} stroke="none" label={zLabel("diamond-held", "#22d3ee", "insideTopRight")} />
            <ReferenceArea y1={0} y2={20} fill="#fb7185" fillOpacity={0.07} stroke="none" label={zLabel("high turnover", "#fb7185", "insideBottomRight")} />
